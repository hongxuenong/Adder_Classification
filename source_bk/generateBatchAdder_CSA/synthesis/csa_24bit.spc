...
XOAI21X1_85 gnd vdd w_cout[4] _295_ w_cout[5] _296_ OAI21X1
...
XINVX1_66 gnd _364_ vdd gnd INVX1
XOR2X2_41 _365_ i_add_term1[0] vdd gnd i_add_term2[0] OR2X2
XNAND2X1_106 vdd _366_ gnd i_add_term2[0] i_add_term1[0] NAND2X1
XNAND3X1_41 _366_ vdd gnd _364_ _365_ _367_ NAND3X1
XNOR2X1_41 vdd i_add_term1[0] gnd _361_ i_add_term2[0] NOR2X1
XAND2X2_41 vdd gnd i_add_term2[0] i_add_term1[0] _362_ AND2X2
XOAI21X1_106 gnd vdd _361_ _362_ _363_ gnd OAI21X1
XNAND2X1_107 vdd rca_inst.fa0.o_sum gnd _363_ _367_ NAND2X1
XOAI21X1_107 gnd vdd _364_ _361_ rca_inst.fa0.o_carry _366_ OAI21X1
XINVX1_67 rca_inst.fa31.i_carry _371_ vdd gnd INVX1
XOR2X2_42 _372_ i_add_term1[3] vdd gnd i_add_term2[3] OR2X2
XNAND2X1_108 vdd _373_ gnd i_add_term2[3] i_add_term1[3] NAND2X1
XNAND3X1_42 _373_ vdd gnd _371_ _372_ _374_ NAND3X1
XNOR2X1_42 vdd i_add_term1[3] gnd _368_ i_add_term2[3] NOR2X1
XAND2X2_42 vdd gnd i_add_term2[3] i_add_term1[3] _369_ AND2X2
XOAI21X1_108 gnd vdd _368_ _369_ _370_ rca_inst.fa31.i_carry OAI21X1
XNAND2X1_109 vdd rca_inst.fa31.o_sum gnd _370_ _374_ NAND2X1
XOAI21X1_109 gnd vdd _371_ _368_ rca_inst.cout _373_ OAI21X1
XINVX1_68 rca_inst.fa0.o_carry _378_ vdd gnd INVX1
XOR2X2_43 _379_ i_add_term1[1] vdd gnd i_add_term2[1] OR2X2
XNAND2X1_110 vdd _380_ gnd i_add_term2[1] i_add_term1[1] NAND2X1
XNAND3X1_43 _380_ vdd gnd _378_ _379_ _381_ NAND3X1
XNOR2X1_43 vdd i_add_term1[1] gnd _375_ i_add_term2[1] NOR2X1
XAND2X2_43 vdd gnd i_add_term2[1] i_add_term1[1] _376_ AND2X2
XOAI21X1_110 gnd vdd _375_ _376_ _377_ rca_inst.fa0.o_carry OAI21X1
XNAND2X1_111 vdd rca_inst.fa[1].o_sum gnd _377_ _381_ NAND2X1
XOAI21X1_111 gnd vdd _378_ _375_ rca_inst.fa[1].o_carry _380_ OAI21X1
XINVX1_69 rca_inst.fa[1].o_carry _385_ vdd gnd INVX1
XOR2X2_44 _386_ i_add_term1[2] vdd gnd i_add_term2[2] OR2X2
XNAND2X1_112 vdd _387_ gnd i_add_term2[2] i_add_term1[2] NAND2X1
XNAND3X1_44 _387_ vdd gnd _385_ _386_ _388_ NAND3X1
XNOR2X1_44 vdd i_add_term1[2] gnd _382_ i_add_term2[2] NOR2X1
XAND2X2_44 vdd gnd i_add_term2[2] i_add_term1[2] _383_ AND2X2
XOAI21X1_112 gnd vdd _382_ _383_ _384_ rca_inst.fa[1].o_carry OAI21X1
XNAND2X1_113 vdd rca_inst.fa[2].o_sum gnd _384_ _388_ NAND2X1
XOAI21X1_113 gnd vdd _385_ _382_ rca_inst.fa31.i_carry _387_ OAI21X1
...
XBUFX2_29 vdd gnd rca_inst.fa31.o_sum _0_[3] BUFX2
