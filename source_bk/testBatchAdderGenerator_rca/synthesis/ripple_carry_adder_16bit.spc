*SPICE netlist created from BLIF module ripple_carry_adder_16bit by blif2BSpice
.include /usr/local/share/qflow/tech/osu035/osu035_stdcells.sp
.subckt ripple_carry_adder_16bit vdd gnd i_add_term1[0] i_add_term1[1] i_add_term1[2] i_add_term1[3] i_add_term1[4] i_add_term1[5] i_add_term1[6] i_add_term1[7] i_add_term1[8] i_add_term1[9] i_add_term1[10] i_add_term1[11] i_add_term1[12] i_add_term1[13] i_add_term1[14] i_add_term1[15] i_add_term2[0] i_add_term2[1] i_add_term2[2] i_add_term2[3] i_add_term2[4] i_add_term2[5] i_add_term2[6] i_add_term2[7] i_add_term2[8] i_add_term2[9] i_add_term2[10] i_add_term2[11] i_add_term2[12] i_add_term2[13] i_add_term2[14] i_add_term2[15] o_result[0] o_result[1] o_result[2] o_result[3] o_result[4] o_result[5] o_result[6] o_result[7] o_result[8] o_result[9] o_result[10] o_result[11] o_result[12] o_result[13] o_result[14] o_result[15] o_result[16] 
XBUFX2_1 vdd gnd _0_[10] o_result[10] BUFX2
XBUFX2_2 vdd gnd _0_[11] o_result[11] BUFX2
XBUFX2_3 vdd gnd _0_[12] o_result[12] BUFX2
XBUFX2_4 vdd gnd _0_[13] o_result[13] BUFX2
XBUFX2_5 vdd gnd _0_[14] o_result[14] BUFX2
XBUFX2_6 vdd gnd _0_[15] o_result[15] BUFX2
XBUFX2_7 vdd gnd w_CARRY[16] o_result[16] BUFX2
XBUFX2_8 vdd gnd _0_[0] o_result[0] BUFX2
XBUFX2_9 vdd gnd _0_[1] o_result[1] BUFX2
XBUFX2_10 vdd gnd _0_[2] o_result[2] BUFX2
XBUFX2_11 vdd gnd _0_[3] o_result[3] BUFX2
XBUFX2_12 vdd gnd _0_[4] o_result[4] BUFX2
XBUFX2_13 vdd gnd _0_[5] o_result[5] BUFX2
XBUFX2_14 vdd gnd _0_[6] o_result[6] BUFX2
XBUFX2_15 vdd gnd _0_[7] o_result[7] BUFX2
XBUFX2_16 vdd gnd _0_[8] o_result[8] BUFX2
XBUFX2_17 vdd gnd _0_[9] o_result[9] BUFX2
...
XINVX1_13 gnd _88_ vdd gnd INVX1
XOR2X2_13 _89_ i_add_term1[0] vdd gnd i_add_term2[0] OR2X2
XNAND2X1_25 vdd _90_ gnd i_add_term2[0] i_add_term1[0] NAND2X1
XNAND3X1_13 _90_ vdd gnd _88_ _89_ _91_ NAND3X1
XNOR2X1_13 vdd i_add_term1[0] gnd _85_ i_add_term2[0] NOR2X1
XAND2X2_13 vdd gnd i_add_term2[0] i_add_term1[0] _86_ AND2X2
XOAI21X1_25 gnd vdd _85_ _86_ _87_ gnd OAI21X1
XNAND2X1_26 vdd _0_[0] gnd _87_ _91_ NAND2X1
XOAI21X1_26 gnd vdd _88_ _85_ w_CARRY[1] _90_ OAI21X1
XINVX1_14 w_CARRY[1] _95_ vdd gnd INVX1
XOR2X2_14 _96_ i_add_term1[1] vdd gnd i_add_term2[1] OR2X2
XNAND2X1_27 vdd _97_ gnd i_add_term2[1] i_add_term1[1] NAND2X1
XNAND3X1_14 _97_ vdd gnd _95_ _96_ _98_ NAND3X1
XNOR2X1_14 vdd i_add_term1[1] gnd _92_ i_add_term2[1] NOR2X1
XAND2X2_14 vdd gnd i_add_term2[1] i_add_term1[1] _93_ AND2X2
XOAI21X1_27 gnd vdd _92_ _93_ _94_ w_CARRY[1] OAI21X1
XNAND2X1_28 vdd _0_[1] gnd _94_ _98_ NAND2X1
XOAI21X1_28 gnd vdd _95_ _92_ w_CARRY[2] _97_ OAI21X1
XINVX1_15 w_CARRY[2] _102_ vdd gnd INVX1
XOR2X2_15 _103_ i_add_term1[2] vdd gnd i_add_term2[2] OR2X2
XNAND2X1_29 vdd _104_ gnd i_add_term2[2] i_add_term1[2] NAND2X1
XNAND3X1_15 _104_ vdd gnd _102_ _103_ _105_ NAND3X1
XNOR2X1_15 vdd i_add_term1[2] gnd _99_ i_add_term2[2] NOR2X1
XAND2X2_15 vdd gnd i_add_term2[2] i_add_term1[2] _100_ AND2X2
XOAI21X1_29 gnd vdd _99_ _100_ _101_ w_CARRY[2] OAI21X1
XNAND2X1_30 vdd _0_[2] gnd _101_ _105_ NAND2X1
XOAI21X1_30 gnd vdd _102_ _99_ w_CARRY[3] _104_ OAI21X1
XINVX1_16 w_CARRY[3] _109_ vdd gnd INVX1
XOR2X2_16 _110_ i_add_term1[3] vdd gnd i_add_term2[3] OR2X2
XNAND2X1_31 vdd _111_ gnd i_add_term2[3] i_add_term1[3] NAND2X1
XNAND3X1_16 _111_ vdd gnd _109_ _110_ _112_ NAND3X1
XNOR2X1_16 vdd i_add_term1[3] gnd _106_ i_add_term2[3] NOR2X1
XAND2X2_16 vdd gnd i_add_term2[3] i_add_term1[3] _107_ AND2X2
XOAI21X1_31 gnd vdd _106_ _107_ _108_ w_CARRY[3] OAI21X1
XNAND2X1_32 vdd _0_[3] gnd _108_ _112_ NAND2X1
XOAI21X1_32 gnd vdd _109_ _106_ w_CARRY[4] _111_ OAI21X1
XBUFX2_18 vdd gnd w_CARRY[16] _0_[16] BUFX2
XBUFX2_19 vdd gnd gnd w_CARRY[0] BUFX2
.ends ripple_carry_adder_16bit
