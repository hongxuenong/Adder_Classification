*SPICE netlist created from BLIF module cla_6bit by blif2BSpice
.include /usr/local/share/qflow/tech/osu035/osu035_stdcells.sp
.subckt cla_6bit vdd gnd i_add1[0] i_add1[1] i_add1[2] i_add1[3] i_add1[4] i_add1[5] i_add2[0] i_add2[1] i_add2[2] i_add2[3] i_add2[4] i_add2[5] o_result[0] o_result[1] o_result[2] o_result[3] o_result[4] o_result[5] o_result[6] 
