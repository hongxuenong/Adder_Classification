...
.subckt carry_lookahead_adder_5bit vdd gnd i_add1[0] i_add1[1] i_add1[2] i_add1[3] i_add1[4] i_add2[0] i_add2[1] i_add2[2] i_add2[3] i_add2[4] o_result[0] o_result[1] o_result[2] o_result[3] o_result[4] o_result[5] 
