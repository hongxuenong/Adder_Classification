...
.subckt rca_4bit vdd gnd i_add_term1[0] i_add_term1[1] i_add_term1[2] i_add_term1[3] i_add_term2[0] i_add_term2[1] i_add_term2[2] i_add_term2[3] o_result[0] o_result[1] o_result[2] o_result[3] o_result[4] 
