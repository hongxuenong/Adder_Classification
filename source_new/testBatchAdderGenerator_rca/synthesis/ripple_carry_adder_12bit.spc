*SPICE netlist created from BLIF module ripple_carry_adder_12bit by blif2BSpice
.include /usr/local/share/qflow/tech/osu035/osu035_stdcells.sp
.subckt ripple_carry_adder_12bit vdd gnd i_add_term1[0] i_add_term1[1] i_add_term1[2] i_add_term1[3] i_add_term1[4] i_add_term1[5] i_add_term1[6] i_add_term1[7] i_add_term1[8] i_add_term1[9] i_add_term1[10] i_add_term1[11] i_add_term2[0] i_add_term2[1] i_add_term2[2] i_add_term2[3] i_add_term2[4] i_add_term2[5] i_add_term2[6] i_add_term2[7] i_add_term2[8] i_add_term2[9] i_add_term2[10] i_add_term2[11] o_result[0] o_result[1] o_result[2] o_result[3] o_result[4] o_result[5] o_result[6] o_result[7] o_result[8] o_result[9] o_result[10] o_result[11] o_result[12] 
...
XINVX1_1 w_CARRY[5] _11_ vdd gnd INVX1
...
XINVX1_2 w_CARRY[6] _18_ vdd gnd INVX1
...
XINVX1_3 w_CARRY[7] _25_ vdd gnd INVX1
...
XINVX1_4 w_CARRY[8] _32_ vdd gnd INVX1
...
XINVX1_5 w_CARRY[9] _39_ vdd gnd INVX1
...
XINVX1_6 w_CARRY[10] _46_ vdd gnd INVX1
...
XINVX1_7 w_CARRY[11] _53_ vdd gnd INVX1
XOR2X2_7 _54_ i_add_term1[11] vdd gnd i_add_term2[11] OR2X2
...
XINVX1_8 gnd _60_ vdd gnd INVX1
XOR2X2_8 _61_ i_add_term1[0] vdd gnd i_add_term2[0] OR2X2
XNAND2X1_17 vdd _62_ gnd i_add_term2[0] i_add_term1[0] NAND2X1
XNAND3X1_9 _62_ vdd gnd _60_ _61_ _63_ NAND3X1
XNOR2X1_9 vdd i_add_term1[0] gnd _57_ i_add_term2[0] NOR2X1
XAND2X2_9 vdd gnd i_add_term2[0] i_add_term1[0] _58_ AND2X2
XOAI21X1_17 gnd vdd _57_ _58_ _59_ gnd OAI21X1
XNAND2X1_18 vdd _0_[0] gnd _59_ _63_ NAND2X1
XOAI21X1_18 gnd vdd _60_ _57_ w_CARRY[1] _62_ OAI21X1
XINVX1_9 w_CARRY[1] _67_ vdd gnd INVX1
XOR2X2_9 _68_ i_add_term1[1] vdd gnd i_add_term2[1] OR2X2
XNAND2X1_19 vdd _69_ gnd i_add_term2[1] i_add_term1[1] NAND2X1
XNAND3X1_10 _69_ vdd gnd _67_ _68_ _70_ NAND3X1
XNOR2X1_10 vdd i_add_term1[1] gnd _64_ i_add_term2[1] NOR2X1
XAND2X2_10 vdd gnd i_add_term2[1] i_add_term1[1] _65_ AND2X2
XOAI21X1_19 gnd vdd _64_ _65_ _66_ w_CARRY[1] OAI21X1
XNAND2X1_20 vdd _0_[1] gnd _66_ _70_ NAND2X1
XOAI21X1_20 gnd vdd _67_ _64_ w_CARRY[2] _69_ OAI21X1
XINVX1_10 w_CARRY[2] _74_ vdd gnd INVX1
XOR2X2_10 _75_ i_add_term1[2] vdd gnd i_add_term2[2] OR2X2
XNAND2X1_21 vdd _76_ gnd i_add_term2[2] i_add_term1[2] NAND2X1
XNAND3X1_11 _76_ vdd gnd _74_ _75_ _77_ NAND3X1
XNOR2X1_11 vdd i_add_term1[2] gnd _71_ i_add_term2[2] NOR2X1
XAND2X2_11 vdd gnd i_add_term2[2] i_add_term1[2] _72_ AND2X2
XOAI21X1_21 gnd vdd _71_ _72_ _73_ w_CARRY[2] OAI21X1
XNAND2X1_22 vdd _0_[2] gnd _73_ _77_ NAND2X1
XOAI21X1_22 gnd vdd _74_ _71_ w_CARRY[3] _76_ OAI21X1
XINVX1_11 w_CARRY[3] _81_ vdd gnd INVX1
XOR2X2_11 _82_ i_add_term1[3] vdd gnd i_add_term2[3] OR2X2
XNAND2X1_23 vdd _83_ gnd i_add_term2[3] i_add_term1[3] NAND2X1
XNAND3X1_12 _83_ vdd gnd _81_ _82_ _84_ NAND3X1
XNOR2X1_12 vdd i_add_term1[3] gnd _78_ i_add_term2[3] NOR2X1
XAND2X2_12 vdd gnd i_add_term2[3] i_add_term1[3] _79_ AND2X2
XOAI21X1_23 gnd vdd _78_ _79_ _80_ w_CARRY[3] OAI21X1
XNAND2X1_24 vdd _0_[3] gnd _80_ _84_ NAND2X1
XOAI21X1_24 gnd vdd _81_ _78_ w_CARRY[4] _83_ OAI21X1
...
XBUFX2_13 vdd gnd w_CARRY[12] o_result[12] BUFX2
XINVX1_12 w_CARRY[4] _4_ vdd gnd INVX1
XOR2X2_12 _5_ i_add_term1[4] vdd gnd i_add_term2[4] OR2X2
XBUFX2_14 vdd gnd w_CARRY[12] _0_[12] BUFX2
XBUFX2_15 vdd gnd gnd w_CARRY[0] BUFX2
.ends ripple_carry_adder_12bit
