*SPICE netlist created from BLIF module rca_18bit by blif2BSpice
.include /usr/local/share/qflow/tech/osu035/osu035_stdcells.sp
.subckt rca_18bit vdd gnd i_add_term1[0] i_add_term1[1] i_add_term1[2] i_add_term1[3] i_add_term1[4] i_add_term1[5] i_add_term1[6] i_add_term1[7] i_add_term1[8] i_add_term1[9] i_add_term1[10] i_add_term1[11] i_add_term1[12] i_add_term1[13] i_add_term1[14] i_add_term1[15] i_add_term1[16] i_add_term1[17] i_add_term2[0] i_add_term2[1] i_add_term2[2] i_add_term2[3] i_add_term2[4] i_add_term2[5] i_add_term2[6] i_add_term2[7] i_add_term2[8] i_add_term2[9] i_add_term2[10] i_add_term2[11] i_add_term2[12] i_add_term2[13] i_add_term2[14] i_add_term2[15] i_add_term2[16] i_add_term2[17] o_result[0] o_result[1] o_result[2] o_result[3] o_result[4] o_result[5] o_result[6] o_result[7] o_result[8] o_result[9] o_result[10] o_result[11] o_result[12] o_result[13] o_result[14] o_result[15] o_result[16] o_result[17] o_result[18] 
XBUFX2_1 vdd gnd _0_[8] o_result[8] BUFX2
XBUFX2_2 vdd gnd _0_[9] o_result[9] BUFX2
XBUFX2_3 vdd gnd _0_[10] o_result[10] BUFX2
XBUFX2_4 vdd gnd _0_[11] o_result[11] BUFX2
XBUFX2_5 vdd gnd _0_[12] o_result[12] BUFX2
XBUFX2_6 vdd gnd _0_[13] o_result[13] BUFX2
XBUFX2_7 vdd gnd _0_[14] o_result[14] BUFX2
XBUFX2_8 vdd gnd _0_[15] o_result[15] BUFX2
XBUFX2_9 vdd gnd _0_[16] o_result[16] BUFX2
XBUFX2_10 vdd gnd _0_[17] o_result[17] BUFX2
XBUFX2_11 vdd gnd w_CARRY[18] o_result[18] BUFX2
XBUFX2_12 vdd gnd _0_[0] o_result[0] BUFX2
XBUFX2_13 vdd gnd _0_[1] o_result[1] BUFX2
XBUFX2_14 vdd gnd _0_[2] o_result[2] BUFX2
XBUFX2_15 vdd gnd _0_[3] o_result[3] BUFX2
XBUFX2_16 vdd gnd _0_[4] o_result[4] BUFX2
XBUFX2_17 vdd gnd _0_[5] o_result[5] BUFX2
XBUFX2_18 vdd gnd _0_[6] o_result[6] BUFX2
XBUFX2_19 vdd gnd _0_[7] o_result[7] BUFX2
...
XINVX1_15 gnd _102_ vdd gnd INVX1
XOR2X2_15 _103_ i_add_term1[0] vdd gnd i_add_term2[0] OR2X2
XNAND2X1_29 vdd _104_ gnd i_add_term2[0] i_add_term1[0] NAND2X1
XNAND3X1_15 _104_ vdd gnd _102_ _103_ _105_ NAND3X1
XNOR2X1_15 vdd i_add_term1[0] gnd _99_ i_add_term2[0] NOR2X1
XAND2X2_15 vdd gnd i_add_term2[0] i_add_term1[0] _100_ AND2X2
XOAI21X1_29 gnd vdd _99_ _100_ _101_ gnd OAI21X1
XNAND2X1_30 vdd _0_[0] gnd _101_ _105_ NAND2X1
XOAI21X1_30 gnd vdd _102_ _99_ w_CARRY[1] _104_ OAI21X1
XINVX1_16 w_CARRY[1] _109_ vdd gnd INVX1
XOR2X2_16 _110_ i_add_term1[1] vdd gnd i_add_term2[1] OR2X2
XNAND2X1_31 vdd _111_ gnd i_add_term2[1] i_add_term1[1] NAND2X1
XNAND3X1_16 _111_ vdd gnd _109_ _110_ _112_ NAND3X1
XNOR2X1_16 vdd i_add_term1[1] gnd _106_ i_add_term2[1] NOR2X1
XAND2X2_16 vdd gnd i_add_term2[1] i_add_term1[1] _107_ AND2X2
XOAI21X1_31 gnd vdd _106_ _107_ _108_ w_CARRY[1] OAI21X1
XNAND2X1_32 vdd _0_[1] gnd _108_ _112_ NAND2X1
XOAI21X1_32 gnd vdd _109_ _106_ w_CARRY[2] _111_ OAI21X1
XINVX1_17 w_CARRY[2] _116_ vdd gnd INVX1
XOR2X2_17 _117_ i_add_term1[2] vdd gnd i_add_term2[2] OR2X2
XNAND2X1_33 vdd _118_ gnd i_add_term2[2] i_add_term1[2] NAND2X1
XNAND3X1_17 _118_ vdd gnd _116_ _117_ _119_ NAND3X1
XNOR2X1_17 vdd i_add_term1[2] gnd _113_ i_add_term2[2] NOR2X1
XAND2X2_17 vdd gnd i_add_term2[2] i_add_term1[2] _114_ AND2X2
XOAI21X1_33 gnd vdd _113_ _114_ _115_ w_CARRY[2] OAI21X1
XNAND2X1_34 vdd _0_[2] gnd _115_ _119_ NAND2X1
XOAI21X1_34 gnd vdd _116_ _113_ w_CARRY[3] _118_ OAI21X1
XINVX1_18 w_CARRY[3] _123_ vdd gnd INVX1
XOR2X2_18 _124_ i_add_term1[3] vdd gnd i_add_term2[3] OR2X2
XNAND2X1_35 vdd _125_ gnd i_add_term2[3] i_add_term1[3] NAND2X1
XNAND3X1_18 _125_ vdd gnd _123_ _124_ _126_ NAND3X1
XNOR2X1_18 vdd i_add_term1[3] gnd _120_ i_add_term2[3] NOR2X1
XAND2X2_18 vdd gnd i_add_term2[3] i_add_term1[3] _121_ AND2X2
XOAI21X1_35 gnd vdd _120_ _121_ _122_ w_CARRY[3] OAI21X1
XNAND2X1_36 vdd _0_[3] gnd _122_ _126_ NAND2X1
XOAI21X1_36 gnd vdd _123_ _120_ w_CARRY[4] _125_ OAI21X1
XBUFX2_20 vdd gnd w_CARRY[18] _0_[18] BUFX2
XBUFX2_21 vdd gnd gnd w_CARRY[0] BUFX2
.ends rca_18bit
